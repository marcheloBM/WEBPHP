...
<head>
    ...
    <title>Home | TrackMyPC - Presupuestos-Repuesto</title>
					...
					<div class="row">
					    ...
					    <div class="panel-body">
                            <div class="pad-btm form-inline">
					            <div class="row">
                                                        <form action="../php/PDFEquipo2.php" method="post">
                                                            <div class="col-sm-6 table-toolbar-left">
                                                                <button id="demo-btn-addrow" class="btn btn-purple" name="btnAccion" value="PDFEquipo" type="submit"><i class="demo-pli-add"></i> PDF Equipos</button>
                                                            </div>
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
                                            ...
                                            <li  class="active-link"><a href="PresupuestosAll.php">All Presupuestos</a></li>
