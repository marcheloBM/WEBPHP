					...
					<div class="row">
					        <div class="panel">
					            <div class="panel-heading">
					                <h3 class="panel-title">Datos de Tecnico</h3>
					            </div>
					                        ...
					                        <div class="col-sm-6">
					                            ...
					                            <div class="form-group">
					                                <label class="control-label">Experiencia (Años)</label>
                                                                        <input type="text" class="form-control" name="txtexperiencia">
					                            </div>
					                        </div>
					                    </div>
					                </div>
					                <div class="panel-footer text-right">
					                    <button class="btn btn-success" name="RegistrarTec" value="RegistrarTec" type="submit">Agregar Cliente</button>
					                </div>
					            </form>
					            <!--===================================================-->
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
                                            ...
                                            <li class="active-link"><a href="#">Datos Tecnico</a></li>
