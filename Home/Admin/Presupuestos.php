...
<head>
    ...
    <title>Home | TrackMyPC - Presupuestos</title>
                                                        ...
                                                        echo '<td>
                                                                <form action="../php/Presupuesto.php" method="post">
                                                                    <div class="btn-group btn-group-xs">
                                                                        ...
                                                                        <button class="btn btn-success" name="AprobarPresupuestoAdmin" value="AprobarPresupuestoAdmin" type="submit">Aceptar</button>
                                                                        <button class="btn btn-danger"  name="RechazarPresupuestoAdmin" value="RechazarPresupuestoAdmin" type="submit">Rechazar</button>
                                                                    </div>
                                                                </form>
                                                            </td>';
                                                    }else{
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
                                            ...
                                            <li class="active-link"><a href="Presupuestos.php">Presupuestos Pendientes</a></li>
