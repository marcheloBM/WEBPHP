					...
					<div class="row">
					        <div class="panel">
					            <div class="panel-heading">
					                <h3 class="panel-title">Lista Agendas</h3>
					            </div>
					            ...
					            <table class="table table-striped">
					                <thead>
					                    <tr>
                                            ...
                                            <th>ID<br>Tecnico</th>
                                            <th>Nombre<br>Tecnico</th>
                                            <th>Apellido<br>Tecnico</th>
                                            
                                            <th>ID<br>Cliente</th>
                                            <th>Nombre<br>Cliente</th>
                                            <th>Apellido<br>Cliente</th>
                                            <th>Acciones</th>
					                    </tr>
					                </thead>
                                        <?php
					                ...
					                <tbody>
                                        <?php
                                            if (!empty($agendas)) {
                                                foreach ($agendas as $agenda) {
                                                    ...
                                                    <td>{$agenda['idTecnico']}</td>
                                                    <td>{$agenda['nombreTec']}</td>
                                                    <td>{$agenda['apellidoTec']}</td>
                                                    <td>{$agenda['idCliente']}</td>
                                                    <td>{$agenda['nombreCli']}</td>
                                                    <td>{$agenda['apellidoCli']}</td>";

                                                    
                                                    
                                                    echo "<td>
                                                    <a class='btn-link' href='AgendaUpdate.php?id={$agenda['idAgenda']}'> Modificar</a>
                                                    <a class='btn-link' href='../php/Agenda.php?btnAccion=Eliminar&idag={$agenda['idAgenda']}'> Eliminar</a>
                                                    </td>";
                                                    echo "</tr>";
                                                }
                                            } else {
					                    ...
					                    <button class="btn btn-success" onclick="window.location.href='AgregarAgenda.php'"> Agregar Agenda</button>
					                </div>
					        </div>
					    </div>
					    <!--===================================================-->
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
                                            ...
                                            <li class="active-link"><a href="MantenedorAgenda.php">Mantenedor Agenda</a></li>
