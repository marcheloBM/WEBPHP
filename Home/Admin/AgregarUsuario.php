					        ...
					        <div class="panel">
					            ...
					            <form action="../php/Usuario.php" method="POST">
					                    ...
					                    <div class="row">
					                        <div class="col-sm-6">
					                            <div class="form-group">
					                                <label class="control-label">Rut del Cliente</label>
                                                                        <input type="text" class="form-control" name="txtrut" placeholder="Rut de Usuario" required autofocus="" oninput="formatearRut(this); validarRut(this);" maxlength="12">
					                            </div>
					                        </div>
					                        <div class="col-sm-6">
					                            <div class="form-group">
					                ...
					                <div class="panel-footer text-right">
					                    <button class="btn btn-success" name="RegistrarUserTecAdmin" value="RegistrarUserTecAdmin" type="submit">Agregar Usuario</button>
					                </div>
					            </form>
					            <!--===================================================-->
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
                                            ...
                                            <li class="active-link"><a href="#">Agregar Tecnico</a></li>
