					...
					<div class="row">
					        <div class="panel">
					            <div class="panel-heading">
					                <h3 class="panel-title">Agregar Agenda</h3>
					            </div>
					            ...
					            <form action="../php/Agenda.php" method="POST">
                                                                        ...
                                                                        <select class="form-control" name="opcTec">
                                                                            ...
                                                                            if (!empty($tecnicos)) {
                                                                                foreach ($tecnicos as $tecnico) {
                                                                                    echo "<option value='{$tecnico['idt']}' >{$tecnico['nombre']} {$tecnico['apellido']} </option>";
                                                                                }
                                                                            }
                                                                            ?>
                                                                        </select>
					                        ...
					                        <div class="col-sm-6">
					                            <div class="form-group">
					                                <label class="control-label">Descripcion</label>
                                                                        <textarea placeholder="Descripcion sobre la hora tomada" rows="5" class="form-control" name="txtdescripcion"></textarea>
					                            </div>
					                        </div>
                                                                <div class="col-sm-6">
					                            <div class="form-group">
                                                                        <label class="control-label">Cliente: </label>
                                                                        <select class="form-control" name="opcClie">
                                                                            <?php
                                                                            if (!empty($clientes)) {
					                ...
					                <div class="panel-footer text-right">
					                    <button class="btn btn-success" name="btnAgendarHoraAdmin" value="btnAgendarHoraAdmin" type="submit">Agendar Hora</button>
					                </div>
					            </form>
					            <!--===================================================-->
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
                                            ...
                                            <li class="active-link"><a href="#">Agregar Agenda</a></li>
