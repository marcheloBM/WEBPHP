					...
					<div class="row">
					        <div class="panel">
					            <div class="panel-heading">
					                <h3 class="panel-title">Modificar Agenda</h3>
					            </div>
                                ...
                                <?php
                                    ...
                                    $agendas = listarAgendaID($id);
                                    $tecnicos = leerTecAll();
                                    $clientes = listarClienteAll();
                                    //print "ID de Usuario: {$agendas['tecnico_idtecnico']} ";
                                    ?>
					            <form action="../php/Agenda.php" method="POST">
					                <div class="panel-body">
					                    <div class="row">
					                        <div class="col-sm-6">
					                            <div class="form-group">
					                                <label class="control-label">Selecciona una fecha y hora:</label>
                                                    <input type="datetime-local" id="fechaHora" value="<?php print isset($agendas['fechahora']) ? strval($agendas['fechahora']) : ''; ?>" name="fechaHora">
					                            </div>
					                        </div>
                                                                <div class="col-sm-6">
					                            <div class="form-group">
                                                                        <label class="control-label">Tecnico: </label>
                                                                        <select class="form-control" name="opcTec">
                                                                        <?php
                                                                            if (!empty($tecnicos)) {
                                                                                foreach ($tecnicos as $tecnico) {
                                                                                    $selected = ($tecnico['idt'] == $agendas['tecnico_idtecnico']) ? 'selected' : '';
                                                                                    echo "<option value='{$tecnico['idt']}' {$selected}>{$tecnico['nombre']} {$tecnico['apellido']} </option>";
                                                                                }
                                                                            }
                                                                            ?>
                                                                        </select>
					                        ...
					                        <div class="col-sm-6">
					                            <div class="form-group">
					                                <label class="control-label">Descripcion</label>
                                                                        <textarea placeholder="Descripcion sobre la hora tomada" rows="5" class="form-control" name="txtdescripcion"><?php print isset($agendas['descripcion']) ? strval($agendas['descripcion']) : ''; ?></textarea>
					                            </div>
					                        </div>
                                                                <div class="col-sm-6">
					                            <div class="form-group">
                                                                        <label class="control-label">Cliente: </label>
                                                                        <select class="form-control" name="opcCli">
                                                                            <?php
                                                                            if (!empty($clientes)) {
                                                                                foreach ($clientes as $cliente) {
                                                                                    $selected = ($cliente['idcliente'] == $agendas['cliente_idcliente']) ? 'selected' : '';
					                ...
					                <div class="panel-footer text-right">
                                                            <input type="hidden" name="idage" value="<?php print $agendas['idagenda'] ?>">
					                    <button class="btn btn-success" name="btnActualizarAgenda" value="btnActualizarAgenda" type="submit">Actualizar Agendar</button>
					                </div>
					            </form>
					            <!--===================================================-->
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
                                            ...
                                            <li class="active-link"><a href="#">Actualizar Agenda</a></li>
