                                        ...
                                        <?php
                                            ...
                                            if (!empty($equipos)) {
												foreach ($equipos as $equipo) {
                                                    ...
                                                    // Lógica de estado
													if ($estado == 'Terminado') {
														echo '<div class="label label-table label-success">' . $estado . '</div>';
                                                    ...
                                                    echo "</td>
													<td>
                                                        <a class='btn-link' href='Presupuestos.php?id={$equipo['presupuesto_idpresupuesto']}'>
                                                        N# {$equipo['presupuesto_idpresupuesto']}
                                                        </a>
													</td>";
                                                    echo "<td>{$equipo['nombre']} {$equipo['apellido']}</td>
													</tr>";

                                                }

                                            } else {
                                                echo "<tr><td colspan='7'>No hay equipos para mostrar.</td></tr>";
                                            }
