                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="<?php print isset($repuesto['nombre']) ? strval($repuesto['nombre']) : 'Sin DATOS'; ?>" disabled="">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="control-label">Descripcion: </label>
                                                <textarea rows="5" class="form-control" placeholder="<?php print isset($repuesto['descripcion']) ? strval($repuesto['descripcion']) : 'Sin DATOS'; ?>" disabled=""></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="<?php print isset($repuesto['precio']) ? strval($repuesto['precio']) : 'Sin DATOS'; ?>" disabled="">
                                            </select>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
                                            ...
                                            <li class="active-link"><a href="ListarEquipos.php">Listar Equipos</a></li>
                                            <li class="active-link"><a href="ListarEquipos.php">Presupuesto</a></li>
