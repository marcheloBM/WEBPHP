                ...
                <div id="page-content">
					...
					<div class="row">
					        <div class="panel">
					            ...
					            <form action="../php/Equipo.php" method="POST">
					                    ...
					                    <div class="row">
					                        <div class="col-sm-6">
					                            <div class="form-group">
					                                ...
					                                <input type="text" class="form-control" name="txtnumSerie">
					                            </div>
					                        </div>
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" name="opcClie">
                                                                            ...
                                                                            if (!empty($clientes)) {
                                                                                foreach ($clientes as $cliente) {
                                                                                    echo "<option value='{$cliente['idusuario']}'> {$cliente['nombre']} {$cliente['apellido']}</option>";
                                                                                }
					                ...
					                <div class="panel-footer text-right">
					                    <button class="btn btn-success" name="btnAgregarEquipo" value="AgregarEquipo" type="submit">Agregar Equipo</button>
					                </div>
					            </form>
					            <!--===================================================-->
