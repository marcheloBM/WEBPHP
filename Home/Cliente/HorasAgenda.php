...
<head>
    ...
    <title>Home | TrackMyPC - Horas</title>
					...
					<div class="row">
					        <div class="panel">
					            <div class="panel-heading">
					                <h3 class="panel-title">Horas Agendadas</h3>
					            </div>
                                        ...
                                        <?php
                                            ...
                                            if (!empty($agendas)) {
												foreach ($agendas as $agenda) {
                                                    ...
                                                    $tecnicos = listarTecnicoUsuario($agenda['tecnico_idtecnico']);
                                                    if (!empty($tecnicos)) {
												        foreach ($tecnicos as $tecnico) {
                                                            echo "<td>{$tecnico['nombre']} {$tecnico['apellido']}</td></tr>";
                                                        }
                                                    }
                                                }

                                            } else {
                                                echo "<tr><td colspan='7'>No hay horas para mostrar.</td></tr>";
                                            }
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
						                    <li><a href="..\HomeCliente.php">Home</a></li>
                                                                                        <li class="active-link"><a href="HorasAgenda.php">Horas Agendadas</a></li>
