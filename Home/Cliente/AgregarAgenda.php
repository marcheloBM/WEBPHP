					...
					<div class="row">
					        <div class="panel">
					            <div class="panel-heading">
					                <h3 class="panel-title">Agendar Hora</h3>
					            </div>
					            ...
					            <form action="../php/Agenda.php" method="POST">
                                            ...
                                            <div class="col-sm-6">
					                            <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="opcTec">
                                                        ...
                                                        // Obtener la lista de agenda del cliente
                                                        $tecnicos = listarTecnicoUsuarioAll();
                                                        
                                                        if (!empty($tecnicos)) {
                                                            foreach ($tecnicos as $tecnico) {
                                                                echo "<option value='{$tecnico['idtecnico']}'> {$tecnico['nombre']} {$tecnico['apellido']}</option>";
                                                            }

                                                        } else {
                                                            echo "<option value='0'> sin tecnicos</option>";
                                                        }
                                                        ?>
					                ...
					                <div class="panel-footer text-right">
					                    <button class="btn btn-success" name="btnRegistrarAgenda" value="AgendarHora" type="submit">Agendar Hora</button>
					                </div>
					            </form>
					            <!--===================================================-->
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="AgregarAgenda.php">Agendar Hora</a></li>
