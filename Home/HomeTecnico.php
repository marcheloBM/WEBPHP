                ...
                <div id="page-content">
					...
					<div class="row">
					    ...
					    <div class="panel-heading">
					        <h3 class="panel-title">Horas Programadas</h3>
					    </div>
					            ...
					            <table class="table table-striped">
					                ...
					                <tbody>
                                        <?php
                                            ...
                                            $tecnico = listarTecnicoUsuarioIdUsuario($idusuario);

                                            $id = $tecnico['idtecnico'];
                                            print "ID de tecnio: {$id} ";
											// Obtener la lista de agendas del tecnico
											$agendas = listarAgendaTec($id);
                                        ...
                                        <?php
                                            ...
                                            if (!empty($agendas)) {
												foreach ($agendas as $agenda) {
													echo "<tr>
													<td>{$agenda['fechahora']}</td>
													<td>{$agenda['descripcion']}</td>";
                                                    // Obtener la información del técnico
                                                    $clientes = listarClienteUsuario($agenda['cliente_idcliente']);
                                                    if (!empty($clientes)) {
												        foreach ($clientes as $cliente) {
                                                            echo "<td>{$cliente['nombre']} {$cliente['apellido']}</td></tr>";
                                                        }
                                                    }
                                                }
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
						                    <li class="active-link"><a href="HomeTecnico.php">Home</a></li>
                                                                    <li><a href="Tecnico/AgregarEquipo.php">Agregar Equipo</a></li>
                                                                    <li><a href="Tecnico/AgregarUsuario.php">Agregar Usuario</a></li>
                                                                    <li><a href="Tecnico/ListarEquipos.php">Listar Equipos</a></li>
                                                                    <li><a href="Tecnico/PresupuestosTermi.php">Presupuestos Terminados</a></li>
